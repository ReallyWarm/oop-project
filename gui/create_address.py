...
class CreateAddressGUI(tk.Frame):
    ...
    def save_changes(self):
        ...
        if  res1 == {"data":'Unvailable to create a new address. Please check your name isn\'t duplicate.'}:
            messagebox.showinfo(title='Error',message="You don't have account in this system or your name is duplicate. Please try again")
            print(r1.json())
        else:
