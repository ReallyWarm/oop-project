...
class Profile(tk.Frame):
    ...
    def update_data(self):
        ...
        self.order = self.user_order()
        self.review = self.user_review()
        print(self.user_name_data())
        self.username_label.config(text=str(self.username))
        self.firstname_label.config(text=str(self.firstname))
        self.lastname_label.config(text=str(self.lastname))
        self.email_label.config(text=str(self.email))
        self.company_label.config(text=str(self.company))
        # self.address_text.config(text=str(self.address))
