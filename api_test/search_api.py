...
# r = requests.post('http://127.0.0.1:8000/system/category/subtype/tools/', data=json.dumps(drill_1))
# print(r, r.json())
# drill_2 = {'code':'02x', 'name':'faifa drill', 'description':'POWER', 'brand':'idk', 
#            'amount':12, 'image':None, 'price':800.00, 'type_of_tool':'Drills'}
# r = requests.post('http://127.0.0.1:8000/system/category/subtype/tools/', data=json.dumps(drill_2))
# print(r, r.json())
# saw_1 = {'code':'01x', 'name':'Testing saw', 'description':'da-da', 'brand':'idk', 
#          'amount':10, 'image':None, 'price':700.00, 'type_of_tool':'Saws'}
# r = requests.post('http://127.0.0.1:8000/system/category/subtype/tools/', data=json.dumps(saw_1))
# print(r, r.json())
